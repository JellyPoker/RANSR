...
# Data specifications
parser.add_argument('--dir_data', type=str, default='/home/data/ldd/faceSR/celebaSubset/',
                    help='dataset directory')
parser.add_argument('--dir_demo', type=str, default='../test',
                    help='demo image directory')
parser.add_argument('--data_train', type=str, default='celeba',
...
parser.add_argument('--offset_val', type=int, default=40000,
...
parser.add_argument('--rabtype', type=str, default='c',
                    help='select specific structure')
