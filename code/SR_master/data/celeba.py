...
class celeba(srdata.SRData):
    def __init__(self, args, train=True):
        super(celeba, self).__init__(args, train)
        self.repeat = args.test_every // (args.n_train // args.batch_size)
        self.hrsize = args.hrsize
    ...
    def _set_filesystem(self, dir_data):
        self.apath = dir_data + '/celeba'
        self.dir_hr = os.path.join(self.apath, 'celeba_train_HR_',self.hrsize)
        self.dir_lr = os.path.join(self.apath, 'celeba_train_LR')
        self.ext = '.jpg'
